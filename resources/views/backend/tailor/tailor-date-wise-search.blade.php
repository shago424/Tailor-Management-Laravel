...
<!-- Content Wrapper. Contains page content -->
  ...
  <form method="GET" action="{{ route('tailors.date-details-wise-report-pdf') }}" id="myform" target="_blank">
   <div class="row">
        <div class="col-sm-3">
        ...
        <input type="submit" name="" class="btn btn-success" target="_blank" value=" PDF Report">
         ...
         <br>
           ...
           <form method="GET" action="{{ route('tailors.date-details-wise-report') }}" id="myform2">
   <div class="row"> 
...
<!-- Strat Card Body 2 -->
    ...
    @else  
                ...
                <td style="text-align: center;">{{$invoice->issue_id}}</td>
                <td style="text-align: center;">{{$invoice->id}}</td>
                <td style="text-align: center;">{{date('d-m-y',strtotime($invoice->issue_date))}}</td>
                ...
                <td style="text-align: right;">{{$invoice['item']['tailor_price']}}</td>
                <td style="text-align: center;">{{$invoice->issue_quantity}}</td>
                <td style="text-align: right;">{{$invoice->tailor_price*$invoice->issue_quantity}}</td>
              </tr>

               @php
                $total_total_sum += $invoice->tailor_price;
