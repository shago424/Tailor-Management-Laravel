                   ...
                   @endphp
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td ><input style="text-align: right;" type="text" name="paid_amount" class="form-control form-control  paid_amount" id="paid_amount" placeholder="Enter Paid Amount" value="{{ @$editdata->paid_amount }}" ></td>
                    </tr>

                     <tr>
                      <th style="text-align: right;" colspan="4">Due Amount</th>
                      <td ><input style="text-align: right;" type="text" name="due_amount" class="form-control form-control  due_amount" id="due_amount" placeholder="Enter Due Amount" value="{{ @$editdata->due_amount }}"></td>
                    </tr>
                    
                     <tr>
                      <th style="text-align: right;" colspan="4">Payment Date</th>
                      <td style="text-align: right;"> <input style="text-align: right;" type="text" name="payment_date" class="form-control"  id="datepicker" placeholder="YYYY-MM-DD" data-validation="requierd"  id="payment_date" readonly="" value="{{ date('d-m-Y',strtotime(@$editdata->payment_date))}}"></td>
                    </tr>
