    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <section class="col-md-12 offset-md-0">
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="inside">ইনসাইড</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="inside" id="inside" class="form-control " placeholder="ইনসাইড "value="{{ $editdata->inside }}">
              </div>
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="komor">কোমর</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="komor" id="komor" class="form-control " placeholder="কোমর " value="{{ $editdata->komor }}">
              </div>
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="thai">থাই</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="thai" id="thai" class="form-control " placeholder="থাই "value="{{ $editdata->thai }}">
              </div>
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="pothers1">অন্যান্য-১</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="pothers1" id="pothers1" class="form-control " placeholder="অন্যান্য-১ "value="{{ $editdata->pothers1 }}">
              </div>
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="pothers2">অন্যান্য-২</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="pothers2" id="pothers2" class="form-control " placeholder="অন্যান্য-২ "value="{{ $editdata->pothers2 }}">
              </div>
           ...
           <div class="col-md-2 text-center">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="pothers3">অন্যান্য-৩</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="pothers3" id="pothers3" class="form-control " placeholder="অন্যান্য-৩ "value="{{ $editdata->pothers3 }}">
              </div>
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="pothers4">অন্যান্য-৪</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="pothers4" id="pothers4" class="form-control " placeholder="অন্যান্য-৪ "value="{{ $editdata->pothers4 }}">
              </div>
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="pothers5">অন্যান্য-৫</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                   <textarea id="pthers5" name="pothers5" class="form-control" rows="4" placeholder="অন্যান্য-৫">{{ $editdata->pothers5 }}</textarea>
              </div>
