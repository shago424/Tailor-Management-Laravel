    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <section class="col-md-12 offset-md-0">
           ...
           <div class="form-row"> 
             ...
             <div class="col-md-3">
              ...
              {{-- 000 --}}
               <div class="col-md-2">
                  <div class="form-group text-right">
                    <label for="balance" class="col-sm-12 control-label" >ব্যালান্স</label>
                  </div>
              </div>
              <div  class="col-md-2">
                    <input style="text-align: center;" type="text" name="balance" id="balance" class="form-control " placeholder="ব্যালান্স " value="{{ $editdata->balance }}">
              </div>
           ...
           <div class="col-md-2">
                  <div class="form-group text-right">
                    <label class="col-sm-12 control-label" for="back">ব্যাক</label>
                  </div>
              </div>
              <div class="col-md-2 text-center">
                    <input style="text-align: center;" type="text" name="back" id="back" class="form-control " placeholder="ব্যাক " value="{{ $editdata->back }}">
              </div>
           ...
           <div class="col-md-2">
            ...
            <div class="col-md-2">
                  <div class="form-group text-right">
                    <label for="design_id_3">ডিজাইন -৫</label>
                    </div>
           </div>
           <div class="col-md-6 text-center">
           ...
           <div class="col-md-2">
            ...
            <div class="col-md-2">
                  <div class="form-group text-right">
                    <label for="design_id_4">ডিজাইন -৬</label>
                    </div>
           </div>
           <div class="col-md-6 text-center">
           ...
           <div class="col-md-2">
            ...
            <div class="col-md-2">
                  <div class="form-group text-right">
                    <label for="design_id_5">ডিজাইন -৭</label>
                    </div>
           </div>
           <div class="col-md-6 text-center">
           ...
           <div class="col-md-2">
            ...
            <div class="col-md-2">
                  <div class="form-group text-right">
                    <label for="design_id_6">ডিজাইন -৮</label>
                    </div>
           </div>
           <div class="col-md-6 text-center">
           ...
           <div class="col-md-2">
            ...
            <div class="col-md-2">
                  <div class="form-group text-right">
                    <label for="design_id_7">ডিজাইন -৯</label>
                    </div>
           </div>
           <div class="col-md-6 text-center">
           ...
           <div class="col-md-2">
            ...
            <div class="col-md-2">
                  <div class="form-group text-right">
                    <label for="design_id_9">ডিজাইন -১০</label>
                    </div>
           </div>
           <div class="col-md-6 text-center">
