...
<!-- Content Wrapper. Contains page content -->
  ...
  <form method="GET" action="{{ route('invoices.daily-payment-report-pdf') }}" id="myform" target="_blank">
   <div class="row"> 
  <div class="col-md-2">
    ...
    <div class="form-group"> 
        ...
        <input type="submit" name="" class="btn btn-success" target="_blank" value="Date By Search PDF Report">
           ...
           <form method="GET" action="{{ route('deliveries.daily-payment-report') }}" id="myform2">
   <div class="row"> 
  <div class="col-md-2">
    <div class="form-group"> 
        <label for="start_date" class="col-sm-12 control-label">Start Date <span class="text-danger">*</span></label>
