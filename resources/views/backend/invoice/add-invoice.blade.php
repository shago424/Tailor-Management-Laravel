...
<!-- Content Wrapper. Contains page content -->
          ...
          <section class="col-md-12 offset-md-0">
           ...
           <div class="card">
              <div class="card-header" style="background-color: #086A87 ">
                <h5 style="color: white">Add Order
                  <a  style="font-weight: bold;font-size: 18px" href="{{route('invoices.order-view')}}" class="btn btn-danger btn-sm float-right"><i class="fa fa-list"> Oredr List</i></a>
                  <a  style="font-weight: bold;font-size: 18px" href="{{route('invoices.view')}}" class="btn btn-warning btn-sm float-right"><i class="fa fa-list"> Oredr Design List</i></a>
                </h5>
              </div> 
  ...
  <div class="col-md-2">
    <div class="form-group"> 
        <label for="invoice_date" class="col-sm-12 control-label">Order Date <span class="text-danger">*</span></label>
      </div>
    </div>
        <div class="col-sm-4">
             <input type="date" name="invoice_date" class="form-control"    placeholder="YYYY-MM-DD" data-validation="requierd" value="{{ $date }}"   id="invoice_date">
            @error('invoice_date')
            ...
            @enderror
             ...
             <div class="col-md-2">
   <div class="form-group">
        <label for="order_no" class="col-sm-12 control-label"> Order No <span class="text-danger">*</span></label>
      </div>
    </div>
        <div class="col-md-4">
          <input type="text"  name="order_no" class="form-control text-center" value="{{$order_no}}" id="order_no" data-validation="requierd" readonly style="background-color:  lightblue ">
          @error('order_no')
            <strong class="text-danger">{{$message}}</strong>
            @enderror
        </div>
        ...
        <div class="col-md-2">
    <div class="form-group"> 
        <label for="delivery_date" class="col-sm-12 control-label">Delivery Date <span class="text-danger">*</span></label>
      </div>
    </div>
        <div class="col-sm-4">
             <input type="date" name="delivery_date" class="form-control"    placeholder="YYYY-MM-DD" data-validation="requierd"   id="delivery_date">
            @error('delivery_date')
            <strong class="text-danger">{{$message}}</strong>
            @enderror
        </div>
 ...
 <div class="col-md-2">
    <div class="form-group"> 
        <label for="item_price" class="col-sm-12 control-label">Item Price <span class="text-danger">*</span></label>
      </div>
    </div>
        <div class="col-sm-4">
          <input type="text" name="item_price" class="form-control text-center" value="{{old('item_price')}}" id="item_price" data-validation="requierd" readonly  style="background-color: #D8FDBA" >
            @error('item_price')
            <strong class="text-danger">{{$message}}</strong>
            @enderror
        </div>
        ...
        <div class="col-md-2">
   <div class="form-group">
        <label for="item_id" class="col-sm-12 control-label"> Item Name <span class="text-danger">*</span></label>
      </div>
    </div>
        <div class="col-sm-4">
...
<br>
 ...
 <div class="form-group col-sm-3">
    ...
    <div class="form-group">
        <div class="col-sm-12">
            <button style="font-size: 20px;font-weight: bold;" type="submit" class="btn btn-success btn-block pull-right" id="storebutton">Create Order</button>
        </div>
         </div>
      </form>
   </div>
...
<tr class="delete_add-more_item" id="delete_add-more_item">
  ...
  {{--   <td>
         <input type="text"  name="item_price[]"  class="form-control form-control-sm text-center item_price">
    </td>
   --}}
    <td>
...
<script type="text/javascript">
  ...
  $(document).on("click",".addeventmore", function (){
    ...
    if(invoice_date == ''){
      $.notify("Order Date Required",{globalPosition:'top right}',className:'error'}); 
      return false;
    }
    if(delivery_date == ''){
      $.notify("Delivery Date Required",{globalPosition:'top right}',className:'error'}); 
      return false;
    }
     if(order_no == ''){
      $.notify("Order No Required",{globalPosition:'top right}',className:'error'});
      return false;
    }
 
     if(item_id == ''){
      $.notify("Item Name Required",{globalPosition:'top right}',className:'error'});
      return false;
    }
     if(item_price == ''){
      $.notify("Item Price Required",{globalPosition:'top right}',className:'error'});
      return false;
    }
