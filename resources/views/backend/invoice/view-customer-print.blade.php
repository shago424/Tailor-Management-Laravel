          ...
          <section class="col-md-12">
           ...
           <div class="card">
            ...
            <div class="card-body">
                ...
                @php
                 // $all_amount = App\Model\InvoiceDetails::where('invoice_id',$tailor->id)->sum('item_price');
                 @endphp
                    ...
                    @endif
                      ...
                      <td width="12%" style="text-align: center;">
                          <a href="{{route('invoices.allview',$invoice->id)}}" class="btn btn-primary btn-xs"  title="Show All Data"> <i class="fa fa-eye"></i></a>
                           <a href="{{ route('customers.invoice-edit',$invoice->id) }}" class="btn btn-warning btn-xs"  title="Customer Payment"> <i class="fas fa-dollar-sign"></i></a>
                           <a href="{{route('invoices.customer-invoice-pdf',$invoice->id)}}" target="_blank" class="btn btn-secondary btn-xs"  title="Order Print Customer"> <i class="fa fa-print"></i></a>
                            @if($invoice->status==0)
