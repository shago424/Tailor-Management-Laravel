        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tailor & Admin Wise Payment Report</li>
            </ol>
          </div> 
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <section class="col-md-12 offset-md-0">
           ...
           <div class="card">
              <div class="card-header" style="background-color: #086A87 ">
                <h5 style="color: white">Tailor & Admin Payment Wise Report
                  <a style="font-weight: bold;font-size: 18px"  href="{{route('tailors.view')}}" class="btn btn-warning btn-sm pull-right"><i class="fa fa-list"> Tailor List</i></a>
             ...
             <div class="row">
              <br> <div class="text-center pt-1 pb-1 col-md-12 " style="text-align: center;font-weight: bold;font-size: 20px;background-color: lightgreen">View Report</div>
               <div class="col-md-12 text-center pt-3 pb-3">
                 <strong style="color: green">Tailor Wise Payment Report</strong>&nbsp;&nbsp;&nbsp;
                 <input type="radio" name="member_wise" value="product_wise" class="search_value">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <strong style="color: green">Admin Wise Payment Report</strong>&nbsp;&nbsp;&nbsp;
...
<br>
             ...
             <div class="show_product_wise" style="display: none;">
               <form action="{{ route('tailorpayments.tailor-wise-payment-report') }}" method="GET" id="productwise" >
                 <div class="form-row">
                   <div class="col-sm-8">
             ...
             <div class="show_credit_wise" style="display: none;">
               <form target="_blank" action="{{ route('tailorpayments.admin-wise-payment-report') }}" method="GET" id="creditwise" >
                 <div class="form-row">
                   <div class="col-sm-8">
             ...
             <div class="show_product_wise1" style="display: none;">
               <form action="{{ route('tailorpayments.tailor-wise-payment-report-pdf') }}" method="GET" id="productwise1" target="_blank" >
                 <div class="form-row">
                   <div class="col-sm-8">
                     <label>Tailor Name</label>
                     <select name="tailor_id" class="form-control select2bs4">
             ...
             <div class="show_credit_wise2" style="display: none;">
               <form action="{{ route('tailorpayments.admin-wise-payment-report-pdf') }}" method="GET" id="creditwise1" target="_blank">
                 <div class="form-row">
                   <div class="col-sm-8">
                     <label>Admin Name</label>
                     <select name="user_id" class="form-control select2bs4">
