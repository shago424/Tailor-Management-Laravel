...
<html lang="en">
  ...
  <!-- Theme style -->
    ...
    <title>Individual Tailor All Issue Repoet</title>
  </head>
  <body>
     @if($alldata->isEmpty())
    ...
    @else
        ...
        <div style="font-size: 18px;margin-top: 7px;font-weight: bold;text-align: center;"><u ><i>Individual Tailor All Issue Repoet</i></u></div>
           <br>
