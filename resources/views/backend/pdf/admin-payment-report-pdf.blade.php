...
<html lang="en">
  ...
  <!-- Theme style -->
    ...
    <title>Individual Admin All Payment Repoet</title>
  </head>
  <body>
       @if($alldata->isEmpty())
     <div class="col-md-12 text-center" >
    <h3 style="text-align: center;color: red" class=" text-danger">No Payment </h3>
    </div>
    @else
            ...
            <div class="card-body">
                ...
                <table width="100%" class="table table-bordered table-sm" border="1" >
                  <tbody>
                    ...
                    <tr>
                      <th width="12%" >Admin ID</th>
                      <th width="30%">Admin Name</th>
                      <th width="15%">Mobile</th>
                      <th >Address</th>
                    </tr>
                     <tr>
                      <td style="text-align: center;">{{$alldata['0']['user']['id']}}</td>
                      <td style="text-align: right;">{{$alldata['0']['user']['name']}}</td>
